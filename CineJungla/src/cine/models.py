...
class Empleado(models.Model):
    ...
    def __str__(self):
        return '{} {} {}'.format(self.ced_empleado, self.nom_empleado, self.tipo_empleado)


class Reserva(models.Model):
    cod_reserva = models.UUIDField(primary_key=True, default=uuid.uuid4)
    fecha_reserva = models.DateTimeField()
    cod_vendedor = models.ForeignKey('Empleado', on_delete=models.CASCADE)
...
class Venta(models.Model):
    ...
    ced_vendedor = models.ForeignKey('Empleado', on_delete=models.CASCADE)
...
class Cliente(models.Model):
    ...
    def __init__(self):
        self.ced_cliente = models.UUIDField(primary_key=True, defalut=uuid.uuid4)
        self.nom_cliente = models.CharField(max_length=30)
        self.correo_cliente = models.CharField(max_length=20)
        self.puntos_cliente = models.IntegerField()
